...
----
Un seul joueur par case
Si carte spéciale posée sur objectif
Compteur de sagesse (sur plateau)
piège quand on s'arrête sur une case (ex/ 3 + 1)
Pas deux pièges sur la même case, activé après le départ
Personne sur la même case
pastilles de couleurs imprimées pour symboliser les pièces
-----------------------------------------------------------------------

A chaque début de tour, chaque joueur tire une carte.

Il peut soit jouer sa carte tout de suite, soit la conserver pour la jouer plus tard. 
Il peut conserver plusieurs cartes pour réaliser des combos.

Il y a deux type de cartes:
  - les cartes déplacement qui autorisent un déplacement de n cases 
     - carte 1 case (x24)
     - carte 2 cases (x18)
     - carte 3 cases (x10)


  - les cartes pour interagir avec les autres joueurs
     
   cartes malus:
     - une carte retour de case départ (x02)
     - une carte tous les joueurs se décalent en sens horaire. (x02)
     - le joueur se décale sur le disque supérieur. (x02)
     - le joueur passe son tour. (x02)
     - pile ou face !  pile (rejoue)  face (passe son tour) (x02)
     
   
   cartes bonus 
     - pioche 1 carte de plus (x03)
     - pioche 2 cartes de plus (x01)
     - échange de place !  Le joueur choisis avec qui il change de place. (x01)
     
Le but du jeu est de parcourir un labyrinthe en passant par des étapes obligatoires représentant les différents d'un parcours initiatique : 
   - Apprendre
   - Collecter 
   - Réaliser
...
À chaque nouvelle génération, les villages des terres de Zugoramundi, doivent désigner un prétendant au titre de GRAND HAKOR, le maître du savoir.
Les prétendants sont alors enfermés dans un labyrinthe. 
Ils doivent d'abord y trouver le secret du grand savoir.
Ensuite ils doivent collecter les objets dont ils ont besoin.
Enfin, pour remporter le titre, ils doivent avec les objets collectés et en utilisant les connaissances acquises réaliser une œuvre prouvant qu'ils méritent le titre de GRAND HAKOR.
Le premier joueur qui termine sa grande réalisation gagne la partie. 

Les déplacements dans le labyrinthe suivent un chemin jalonné par des porte de couleur en respectant la séquence de couleur suivante Rouge Vert Bleu. Si le joueur reste bloqué dans un cul de sac, il repart depuis le centre du labyrinthe en respectant la séquence de couleur.

Si deux joueurs se retrouvent face à face et se bloquent mutuellement , on applique la règle de cul de sacs. 

Les joueurs utilisent des cartes état (flexagones) pour indiquer la couleur de la dernière porte franchie.
